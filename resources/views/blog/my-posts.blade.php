    ...
    <x-page-container>
        ...
        <div x-show="tab === 'drafts'">
            ...
            <div class="text-center py-16 text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                ...
                <p>Aucun brouillon.</p>
                <a href="{{ $_blogRoute('create') }}" class="mt-3 inline-block text-indigo-600 dark:text-indigo-400 hover:underline">Écrire un article</a>
            </div>
            @else
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                            ...
                            <td class="px-5 py-4 text-right">
                                <a href="{{ $_blogRoute('edit', ['post' => $post]) }}" class="text-xs text-indigo-600 dark:text-indigo-400 hover:underline">Modifier</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                    ...
                    <div class="flex items-start justify-between gap-4">
                        <div class="min-w-0">
                            ...
                            <p class="mt-2 text-xs text-gray-400">
                                Sur <a href="{{ $_blogRoute('show', ['post' => $comment->post]) }}" class="text-indigo-600 dark:text-indigo-400 hover:underline">{{ $comment->post->title }}</a>
