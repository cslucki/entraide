...
>
    ...
    <textarea
        ...
        x-show="editorError"
        x-model="content"
        class="w-full border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-4 py-3 text-sm min-h-[20rem] focus:ring-2 focus:ring-indigo-500"
