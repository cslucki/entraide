    ...
    <div class="flex justify-around items-center h-16 px-2">
        @php
            ...
            $tabs = auth()->check() ? [
                ...
                ['url' => $organizationRouteParam ? route('organization.flux', ['organization' => $organizationRouteParam]) : route('dashboard'), 'active' => 'flux', 'label' => 'Flux', 'icon' => 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h7l2 2h5a2 2 0 012 2v10a2 2 0 01-2 2z'],
