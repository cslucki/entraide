            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input id="referral_code" type="text" name="referral_code" value="{{ old('referral_code', request('ref')) }}"
                           ...
                           class="w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition text-sm uppercase">
                    <x-input-error :messages="$errors->get('referral_code')" class="mt-1.5" />
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Gagnez des points bonus dès votre inscription !</p>
                </div>
