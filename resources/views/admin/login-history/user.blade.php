<x-admin-layout :title="'Connexions — '.$user->fullName">
    <div class="mb-6">
        <a href="{{ route('admin.stats.login-history') }}" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">&larr; Retour à l'historique</a>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-4 py-3 text-xs text-indigo-600 dark:text-indigo-400">{{ $log->organization?->name ?? '—' }}</td>
                </tr>
                @empty
                <tr>
                    <td colspan="4" class="px-4 py-8 text-center text-sm text-gray-400">Aucune connexion trouvée.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
