                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-750 transition" data-platform-org="{{ $organization->id }}" data-platform-org-known-cost="{{ $consumed ?? '' }}" data-platform-org-unknown="{{ $unknownCount }}">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="flex flex-wrap items-center gap-3">
                                        ...
                                        {{-- TASK-1500 : vers la politique Shell Welcome de CETTE Organization (ancre sur sa ligne). --}}
                                        <a href="{{ route('admin.shell-welcome-config') }}#guest-shell-{{ $organization->slug }}" class="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300 text-xs font-medium" data-platform-org-shell-welcome-link="{{ $organization->slug }}">{{ __('admin.guest_shell_observability_nav') }}</a>
