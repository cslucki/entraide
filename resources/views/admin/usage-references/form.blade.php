    ...
    <div class="max-w-3xl">
        ...
        <form method="POST" action="{{ $reference ? route('admin.usage-references.update', $reference) : route('admin.usage-references.store') }}" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4" data-usage-reference-form>
            ...
            <label class="block">
                ...
                <input type="text" name="title" value="{{ old('title', $reference?->title) }}" maxlength="160" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 text-sm" data-usage-reference-title>
            ...
            <label class="block">
                ...
                <textarea name="content" rows="14" maxlength="{{ $maxChars }}" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 text-sm font-mono" data-usage-reference-content>{{ old('content', $reference?->content) }}</textarea>
