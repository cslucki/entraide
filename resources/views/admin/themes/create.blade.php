            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
                ...
                <div>
                    ...
                    <select name="organization_id"
                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-sm @error('organization_id') border-red-500 @enderror">
                        <option value="">{{ __('themes.main_org') }}</option>
