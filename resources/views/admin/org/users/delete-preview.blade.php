<x-org-admin-layout :organization="$organization" title="Suppression utilisateur">
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center gap-3 mb-6">
            <a href="{{ route('organization.admin.users', $organization) }}" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition">
        ...
        <div class="mb-5 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-xl text-sm text-yellow-700 dark:text-yellow-400">
            ⚠️ <strong>Dry-run uniquement.</strong> Aucune donnée n'a été supprimée.
        </div>
        @endif
        ...
        <form method="POST" action="{{ route('organization.admin.users.delete', [$organization, $user]) }}" class="mt-6 space-y-5">
            @csrf
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 space-y-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Les données transférables seront attribuées à cet utilisateur.</p>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="confirmation" required autocomplete="off" placeholder="Tapez le nom exact"
                ...
                <button type="submit" class="w-full px-6 py-3 bg-red-600 hover:bg-red-700 text-white text-sm font-bold rounded-lg shadow-sm transition">
        ...
        <div class="mt-6 text-center">
            ...
            <a href="{{ route('organization.admin.users', $organization) }}" class="mt-2 inline-block text-sm text-indigo-600 dark:text-indigo-400 hover:underline">
