<x-org-admin-layout title="{{ __('themes.new_theme') }}" :organization="$organization">
    <div class="max-w-2xl">
        <form method="POST" action="{{ route('organization.admin.themes.store', $organization) }}" class="space-y-6">
            @csrf
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="2"
                        ...
                        placeholder="{{ __('themes.description_placeholder') }}">{{ old('description') }}</textarea>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('themes.tokens_help') }}</p>
                <div>
                    <textarea name="tokens" rows="10"
                        ...
                        placeholder='{"page": "#FFFFFF", "surface": "#F3F4F6", "panel": "#FFFFFF", "primary": "#0B4DFF", "text": "#101010", "muted": "#667085", "border": "#DDE3F0"}'>{{ old('tokens') }}</textarea>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('themes.tokens_dark_help') }}</p>
                <div>
                    <textarea name="dark_tokens" rows="10"
                        ...
                        placeholder='{"page": "#0f172a", "surface": "#1e293b", "text": "#f8fafc", "muted": "#94a3b8", "border": "#334155", "primary": "#60a5fa"}'>{{ old('dark_tokens') }}</textarea>
