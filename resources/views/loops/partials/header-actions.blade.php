    ...
    @foreach($frame as $card)
        @if($card['key'] === 'core.members')
            ...
            <button type="button"
                ...
                {{-- Le mot et le nombre. Des visages seuls, ou pire des
                     initiales, ne disent pas ce que le bouton ouvre. --}}
                ...
                <span class="tabular-nums opacity-70">{{ $loopMembers->count() }}</span>
            </button>
        @else
