        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <span class="text-sm sm:text-xs text-gray-500 dark:text-gray-400 font-medium sm:border-l sm:border-gray-300 sm:dark:border-gray-600 sm:pl-2">{{ $currentCommunity->name }}</span>
                    @endisset
                </div>
