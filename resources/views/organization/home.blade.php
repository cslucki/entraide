<x-app-layout :title="$organization->name">
    <section class="min-h-screen bg-[var(--bp-page)] py-6 text-[var(--bp-text)] md:px-8 md:py-8">
        <div class="mx-auto flex min-h-[calc(100vh-3rem)] flex-col border-0 bg-[var(--bp-surface)]/80 shadow-sm backdrop-blur md:min-h-[calc(100vh-4rem)] md:max-w-6xl md:rounded-[2rem]">
            @guest
