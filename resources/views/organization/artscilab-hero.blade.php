...
@include('organization.partials.guest-shell-overlay', ['guestShell' => $guestShell ?? null, 'organization' => $organization, 'position' => 'top'])
  ...
  <footer class="foot">
    ...
    <nav class="foot-right">
      {{-- TASK-1608 — le logigramme.

           Ce gabarit ne porte AUCUN lien Mycelium : « immediatement a droite de
           Mycelium » n'y a donc pas de sens litteral, et lui ajouter Mycelium au
           passage reviendrait a defaire un choix de TASK-1604 sous couvert
           d'addendum. Le lien prend donc la premiere place du pied, ou Mycelium
           serait s'il existait ici. Ecart rapporte a MASTER. --}}
