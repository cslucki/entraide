...
class UserDataLifecycleRegistry
{
    ...
    public static function entries(): array
    {
        return [
            ...
            ['key' => 'blog_comments', 'type' => 'sql', 'table' => 'blog_comments', 'column' => 'user_id', 'policy' => self::POLICY_TRANSFER, 'org_scope' => 'direct', 'justification' => 'Existing dry-run considered blog comments transferable.'],
            ...
            ['key' => 'favorites', 'type' => 'sql', 'table' => 'favorites', 'column' => 'user_id', 'policy' => self::POLICY_TRANSFER, 'org_scope' => 'user_organization', 'justification' => 'Existing dry-run considered favorites transferable.'],
            ['key' => 'feed_post_comments', 'type' => 'sql', 'table' => 'feed_post_comments', 'column' => 'user_id', 'policy' => self::POLICY_TRANSFER, 'org_scope' => 'direct', 'justification' => 'Existing dry-run considered feed comments transferable.'],
            ...
            ['key' => 'point_ledger', 'type' => 'sql', 'table' => 'point_ledger', 'column' => 'user_id', 'policy' => self::POLICY_TRANSFER, 'org_scope' => 'direct', 'justification' => 'Existing dry-run grouped point ledger as owned user data.'],
