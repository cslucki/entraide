...
return [
    ...
    // ── Knowledge console diagnostics (TASK-1307) ─────────────────────────────
    'knowledge_console_col_inspect' => 'Inspect',
    'knowledge_console_inspect' => 'Inspect',
    ...
    'knowledge_console_search_title' => 'Test the search',
    'knowledge_console_search_hint' => 'Raw documentary search (pgvector): no AI generation, no generation cost. One query embedding is computed per search.',
    'knowledge_console_search_placeholder' => 'Search the knowledge…',
    'knowledge_console_search_scope_all' => 'Whole Organization',
    'knowledge_console_search_submit' => 'Search',
    'knowledge_console_search_query_label' => 'Query',
    'knowledge_console_search_col_distance' => 'Distance',
    'knowledge_console_search_col_chunk' => 'Chunk #',
    'knowledge_console_search_col_excerpt' => 'Content',
    'knowledge_console_search_no_results' => 'No results for this query, in this scope.',
    'knowledge_console_search_top5_note' => "RAW ranking by distance (up to 20), without the per-document diversification the product applies before citing 5 sources to a member: if a single document dominates here, that's exactly what diversification corrects for — compare with the real answer in the Loop.",
    'knowledge_console_search_reason_semantic_search_disabled' => 'Semantic search is not enabled for this Organization.',
    'knowledge_console_search_reason_provider_not_configured' => 'No AI credential is configured for this Organization.',
    'knowledge_console_search_reason_no_dossier_in_scope' => 'No Dossier in this scope.',
    ...
    'consumption_console_known_cost' => 'Measured provider cost',
    ...
    'consumption_console_filter_process' => 'Function',
    'consumption_console_filter_model' => 'Model',
    'consumption_console_filter_provider' => 'Provider',
    'consumption_console_by_process' => 'By function',
    ...
    'consumption_console_col_known_cost' => 'Measured provider cost',
    ...
    // TASK-1258: corrected — credential origin IS traced per call in the canonical ledger (T1220); this console does not break it down yet.
    'consumption_console_limit_credential' => 'The credential origin of every call (your Organization\'s key, the platform key, none) is traced in the canonical invocation ledger; this console does not break it down yet: its generation figures come from the interaction register, which does not carry it.',
    'consumption_console_limit_generation_failures' => 'The failures counted here are those of document calls (searches, indexings). A failed generation is not counted as a failure by this register: at best it appears among the "never evaluated" calls.',
    ...
    'consumption_budget_consumed' => 'Consumed (measured provider cost)',
    ...
    'consumption_col_known_cost' => 'Measured provider cost',
    // TASK-1258
    'consumption_col_failed' => 'Failures',
    'consumption_col_function' => 'Function',
    'economy_failed_count' => ':count failure|:count failures',
    ...
    // TASK-1257: the other credit exclusions, counted (in "This month", not in the credit).
    'credit_out_of_scope_ingestion_count' => 'of which :count document indexing outside the credit|of which :count document indexings outside the credit',
    'credit_out_of_scope_undeclared_count' => 'of which :count other document processing outside the credit|of which :count other document processings outside the credit',
    ...
    // TASK-1315 — « BouclePro AI » Shell: the conversational surface that stays
    ...
    'shell_context_title' => 'Context',
    'shell_context_loop' => 'Loop: :name',
    'shell_context_dossier' => 'Folder: :name',
    'shell_context_article' => 'Article: :name',
    'shell_context_dashboard' => 'Dashboard — :name',
    'shell_context_organization' => ':name',
    'shell_context_note' => 'The context says where you are. It grants no access.',
    'shell_placeholder' => 'Tell me what you need…',
    'shell_send' => 'Send',
    'shell_sending' => 'BouclePro AI is thinking…',
    'shell_you' => 'You',
    ...
    'shell_action_open_loop' => 'Open the Loop ":name"',
    'shell_action_prepare_request' => 'Prepare my request',
    ...
    'shell_card_prepare_here' => 'Prepare the request here',
    'shell_card_view_profile' => 'View profile',
    'shell_card_loop_reason_membership' => 'You are an active member of this Loop.',
    'shell_card_ai_wording_note' => 'AI wording, not verified',
    'shell_card_reason_profile_skill' => 'Declared skill: :label',
    'shell_card_reason_profile_help_type' => 'Help type offered: :label',
    'shell_card_reason_profile_problem_helped' => 'Has already helped with: :label',
    ...
    'inspector_intro' => 'Ask your Organization\'s real AI pipeline a question, then see what it actually used to answer.',
    'inspector_help' => 'A real AI call, with your Organization\'s key, counted in your consumption. The active doctrine applies, exactly as it would for a member. Nothing is published, no action is created.',
    'inspector_capability' => 'Tested function',
    'inspector_question' => 'Question',
    'inspector_run' => 'Ask the question',
    ...
    'inspector_field_capability' => 'Executed function',
    'inspector_field_scope' => 'Scope',
    'inspector_field_constitution' => 'Constitution',
    'inspector_field_doctrine' => 'Doctrine',
    'inspector_doctrine_active' => 'Active Organization doctrine',
    'inspector_doctrine_none' => 'No active doctrine',
    'inspector_field_correlation' => 'Correlation ID',
    'inspector_field_ledger' => 'Accounting',
    'inspector_sources_title' => 'Context and sources',
    'inspector_sources_help' => 'The sources this function was allowed to draw on, and what each one returned. A denied source is named by its reason, never by its content.',
    'inspector_source_used' => 'Used',
    'inspector_source_empty' => 'Consulted, nothing returned',
    'inspector_sources_none' => 'This function declares no context source.',
    ...
    'inspector_execution_title' => 'Execution',
    ...
    'inspector_execution_operation' => 'Operation',
    'inspector_execution_provider' => 'Provider',
    'inspector_execution_model' => 'Model',
    ...
    'inspector_authorities_title' => 'Where these are set',
