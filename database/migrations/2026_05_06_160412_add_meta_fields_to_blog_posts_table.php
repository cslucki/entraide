...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('blog_posts', function (Blueprint $table) {
            $table->foreignUuid('organization_id')->nullable()->constrained('organizations')->nullOnDelete()->after('user_id');
    ...
    public function down(): void
    {
        Schema::table('blog_posts', function (Blueprint $table) {
            ...
            $table->dropColumn(['organization_id', 'meta_title', 'meta_description', 'read_time']);
        });
    }
};
