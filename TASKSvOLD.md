...
>
> **Dernière mise à jour : 2026-05-03 - 21h25 (Heure système)**
**IMPORTANT** : mettre à jour la date et heure après chaque modification
...
| ID | Tâche | Agent | Raison |
|---|---|---|---|
| TASK-014 | Notifications temps réel (broadcast) | Claude Code WSL | Nécessite serveur WebSocket en prod |
...
|---|---|---|---|---|
| — | MVP : services, transactions, messagerie, dashboard, notation, favoris, points, signalements, admin | Claude Code | — | 2026-04-28 |
| — | Profil : avatar, bio, localisation, images de service | Jules | PR #1 | 2026-04-30 |
...
| TASK-016 | SEO avancé : OG meta tags + JSON-LD schema.org | Claude Code WSL | PR #16 | 2026-05-03 |
| TASK-017 | Dark mode toggle persistant | Jules | PR #17 | 2026-05-03 |
