...
class AdminSettingTest extends TestCase
{
    ...
    public function test_organization_has_default_settings_on_create(): void
    {
        ...
        $this->assertSame('admin', $org->feed_post_publish_mode);
    }
    ...
    public function test_admin_can_update_feed_post_publish_mode(): void
    {
        $admin = $this->makeAdmin();
        $org = $admin->organization;
        ...
        $this->assertSame('members', $org->feed_post_publish_mode);
    }
