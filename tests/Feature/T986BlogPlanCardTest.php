...
class T986BlogPlanCardTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->post = BlogPost::create([
            ...
            'slug' => 'test-plan-card',
            'summary' => 'Test',
            'content' => '<h1>Intro</h1><p>Text</p><h2>Section 1</h2><p>Text</p><h3>Sous-section</h3><p>Text</p><h2>Section 2</h2><p>Text</p>',
            'status' => 'published',
            'published_at' => now(),
        ]);
    }
    ...
    public function test_show_page_contains_toc_nav_structure(): void
    {
        ...
        $response->assertOk();
        $response->assertSee('href="#heading-intro"', false);
        $response->assertSee('href="#heading-section-2"', false);
    }
